...
function c511007015.initial_effect(c)
	...
	e1:SetCountLimit(1)
	e1:SetTarget(c511007015.target)
	e1:SetOperation(c511007015.operation)
	c:RegisterEffect(e1)
	--Negate Toss and Coin
...
function c511007015.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return true end
	Duel.SetOperationInfo(0,CATEGORY_COIN,nil,0,tp,1)
end
function c511007015.operation(e,tp,eg,ep,ev,re,r,rp)
