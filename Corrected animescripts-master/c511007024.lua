...
function c511007024.condition(e,tp,eg,ep,ev,re,r,rp)
	...
	if not re:IsActiveType(TYPE_MONSTER) and not re:IsActiveType(TYPE_TRAP) and not re:IsActiveType(TYPE_SPELL) and not re:IsHasType(EFFECT_TYPE_ACTIVATE)  then return false end
