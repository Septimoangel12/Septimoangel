...
function c100000478.filter(c,att)
	return c:IsType(TYPE_MONSTER) and c:IsAttribute(att) and c:IsFaceup()
end
function c100000478.spfilter(c,e,tp)
	return c:IsLevelBelow(4) and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP)
		and Duel.IsExistingMatchingCard(c100000478.filter,tp,LOCATION_ONFIELD,0,1,nil,c:GetAttribute())
end
