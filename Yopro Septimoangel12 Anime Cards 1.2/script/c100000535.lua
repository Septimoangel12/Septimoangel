...
function c100000535.cfilter(c)
	...
	return c:IsFaceup() and c:IsType(TYPE_MONSTER) and (code==92377303 or code==46986414 or code==38033121 or code==30208479)
end
...
function c100000535.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	local g=Duel.GetMatchingGroup(c100000535.cfilter,tp,LOCATION_ONFIELD,LOCATION_ONFIELD,nil)
	local ct=g:GetClassCount(Card.GetCode)
	if chk==0 then return ct>1 and Duel.IsExistingMatchingCard(c100000535.dfilter,tp,0,LOCATION_ONFIELD,1,nil) end
