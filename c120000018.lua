...
function c120000018.atkcon(e,tp,eg,ep,ev,re,r,rp)
	...
	return Duel.GetTurnPlayer()==tp and Duel.IsExistingMatchingCard(Card.IsType,e:GetHandlerPlayer(),0,LOCATION_ONFIELD,1,nil,TYPE_MONSTER) and at:IsAttackable() 
...
function c120000018.atktg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	Duel.SelectTarget(tp,Card.IsType,tp,0,LOCATION_ONFIELD,1,1,nil,TYPE_MONSTER)
end
