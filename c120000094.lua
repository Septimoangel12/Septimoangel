...
function c120000094.spreg(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.GetCurrentPhase()==PHASE_END then
		c:RegisterFlagEffect(120000094,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1)
	else
		c:RegisterFlagEffect(120000094,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1)
	end
end
function c120000094.spcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetLocationCount(e:GetHandlerPlayer(),LOCATION_MZONE)>0 and e:GetHandler():GetFlagEffect(120000094)>0
end
